...
const tabs = [
	{
		value: "facility-categories",
		label: "Facility Categories",
		icon: IconCategory,
		Panel: FacilityCategoriesPanel
	},
	{
		value: "facility-types",
		label: "Facility Types",
		icon: IconBuildingFactory,
		Panel: FacilityTypesPanel
	},
	{
		value: "funding-agencies",
		label: "Funding Agencies",
		icon: IconBuildingBank,
		Panel: FundingAgenciesPanel
	},
	{
		value: "funding-categories",
		label: "Funding Categories",
		icon: IconFolderDollar,
		Panel: FundingCategoriesPanel
	},
	{
		value: "program-types",
		label: "Program Types",
		icon: IconLayoutList,
		Panel: ProgramTypesPanel
	},
	{
		value: "project-cycle-statuses",
		label: "Project Cycle Statuses",
		icon: IconCircleDotted,
		Panel: ProjectCycleStatusesPanel
	},
	{
		value: "project-implementation-statuses",
		label: "Implementation Statuses",
		icon: IconProgressCheck,
		Panel: ProjectImplementationStatusesPanel
	},
	{
		value: "project-initiator-categories",
		label: "Initiator Categories",
		icon: IconUsersGroup,
		Panel: ProjectInitiatorCategoriesPanel
	},
	{
		value: "project-types",
		label: "Project Types",
		icon: IconFileDescription,
		Panel: ProjectTypesPanel
	},
	{
		value: "substations",
		label: "Substations",
		icon: IconBolt,
		Panel: SubstationsPanel
	},
	{ value: "vendors", label: "Vendors", icon: IconTruck, Panel: VendorsPanel },
	{
		value: "voltage-transformations",
		label: "Voltage Transformations",
		icon: IconTransform,
		Panel: VoltageTransformationsPanel
	}
];
			...
			<div className="flex flex-col gap-7">
				<div>
					...
					<Text c="dimmed" size="sm" mt={4}>
						Manage all reference data tables in one place
					</Text>
				</div>

				<Tabs
					defaultValue="facility-categories"
